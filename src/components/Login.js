...
export default function Login(){
    ...
    return(
        <div className='bg-black text-black px-4 py-16 sm:border-b-2 border-gray'>
            <form className='flex flex-col gap-4 w-3/4 mx-auto'>
                <NotePencil className='text-black bg-blue mx-auto mb-8 p-2 rounded-full' size={52} />
                ...
                <div className='flex flex-col items-center gap-4 mt-4'>
                    ...
                    {currentUser && <p className='text-sm text-red'>You are already logged.</p>}
                </div>
            </form>
        </div>
    )
